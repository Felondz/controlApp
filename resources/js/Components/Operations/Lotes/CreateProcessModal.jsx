        ...
        <Modal show={show} onClose={onClose} maxWidth="2xl">
            <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden flex flex-col max-h-[calc(100vh-4rem)]">
                ...
                <form onSubmit={submit} className="flex flex-col overflow-hidden">
                    <div className="flex-1 overflow-y-auto overflow-x-hidden p-6 scrollbar-thin space-y-6 pb-6">
                        ...
                        <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                            <div className="flex justify-between items-center mb-4">
                                <InputLabel value={t('operations.configure_stages', 'O configure las etapas del proceso (en orden):')} className="text-sm font-semibold" />
                            ...
                            <div className="space-y-3">
                                {data.stages.map((stage, index) => (
                                    <div key={index} className="flex gap-2 items-start bg-gray-50 dark:bg-gray-900/40 p-3 rounded-lg border border-gray-100 dark:border-gray-800">
                                        ...
                                        <button
                                            ...
                                            className="mt-1.5 text-red-500 hover:text-red-700 transition-colors p-1"
                    ...
                    {/* Actions */}
                    <div className="p-6 border-t border-gray-100 dark:border-gray-700 flex justify-end gap-4 flex-none">
