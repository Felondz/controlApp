                                        ...
                                        {data.es_nomina && (
                                            <>
                                                <div>
                                                    ...
                                                    <div className="flex flex-wrap gap-2 mt-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                                                        {payrollDays.map((day) => (
                                                            <button
                                                                key={day}
                                                                type="button"
                                                                onClick={() => togglePayrollDay(day)}
                                                                className={`w-9 h-9 flex items-center justify-center text-xs font-semibold rounded transition-colors ${data.dia_nomina.includes(day)
