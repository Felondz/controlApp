    ...
    return (
        <div className="space-y-6">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {modules
                    .filter(module => {
                        // Hide chat module for personal projects (chat is for team collaboration)
                        if (project.es_personal && module.id === 'chat') {
                            return false;
                        }
                        return true;
                    })
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-start justify-between gap-4 mb-4">
                                    {/* Icon */}
                                    <div className={`p-3 rounded-lg flex-shrink-0 ${isEnabled
