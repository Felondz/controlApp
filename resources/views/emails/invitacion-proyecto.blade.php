...
@section('content')
    @php
        $invitationUrl = route('invitation.accept', $invitacion->token);
    @endphp
    ...
    <div class="highlight-box">
        <p>
            <strong>Tu rol en el proyecto:</strong> <span
                style="background-color: #e8f4f8; padding: 4px 8px; border-radius: 3px;">
