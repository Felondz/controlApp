...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::prefix('proyectos/{proyecto}/inventory')->group(function () {
        ...
        Route::get('/items/{item}/image', [InventoryItemController::class, 'image'])->name('inventory.items.image');
        Route::post('/items/{item}', [InventoryItemController::class, 'update'])->name('inventory.items.update');
        Route::delete('/items/{item}', [InventoryItemController::class, 'destroy'])->name('inventory.items.destroy');
    });
});
